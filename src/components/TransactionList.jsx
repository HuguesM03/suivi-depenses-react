    ...
    <>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '20px', marginBottom: '10px' }}>
        ...
        {transactions.length > 0 && (
          <button onClick={onClear} style={{ width: 'auto', background: '#e74c3c', color: 'white', padding: '5px 12px', fontSize: '0.75rem', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
            Vider tout
          </button>
        )}
      </div>
      ...
      <input
        ...
        style={{ marginBottom: '15px', width: '100%', padding: '10px', borderRadius: '5px', border: '1px solid #ddd', boxSizing: 'border-box' }}
      />
